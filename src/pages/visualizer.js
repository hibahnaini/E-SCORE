...
Integrates the vowl web plugin to display the core ontology


*/
const Visualizer =() =>{
    return(
        <div className='div-visualizer'>
        ...
        <section id="canvasArea">
            ...
            <div id="loading-info" class="hidden">
                <div id="loading-progress" style={{'border-radius': '10px'}}>
                    ...
                    <div id="layoutLoadingProgressBarContainer" style={{'paddingBottom': 0,	'whiteSpace': 'nowrap',	'overflow': 'hidden',	'textOverflow': 'ellipsis'}}>
                        <h4 id="currentLoadingStep" style={{'margin': 0,'fontStyle': 'italic', 'paddingBottom':0 ,	'whiteSpace': 'nowrap',	'overflow': 'hidden',	'textOverflow': 'ellipsis'}}>
            ...
            <div id="menuContainer">
                ...
                <ul id="m_select" class="toolTipMenu noselect">
                    <li><a href="/vowl#foaf" id="foaf">Friend of a Friend (FOAF) vocabulary</a></li>
                    <li><a href="/vowl#goodrelations" id="goodrelations">GoodRelations Vocabulary for E-Commerce</a></li>
                    <li><a href="/vowl#muto" id="muto">Modular and Unified Tagging Ontology (MUTO)</a></li>
                    <li><a href="/vowl#ontovibe" id="ontovibe">Ontology Visualization Benchmark (OntoViBe)</a></li>
                    <li><a href="/vowl#personasonto" id="personasonto">Personas Ontology (PersonasOnto)</a></li>
                    <li><a href="/vowl#sioc" id="sioc">SIOC (Semantically-Interlinked Online Communities) Core Ontology</a></li>
                    ...
                    <li class="option" id="converter-option">
                        ...
                        <div id="emptyContainer">
                            <a href="/vowl#opts=editorMode=true;#new_ontology1" id="empty" style={{'pointerEvents':'none', 'paddingLeft':0}}>Create new ontology</a>
                        </div>
                        <div>
                ...
                <ul id="m_export" class="toolTipMenu noselect">
                    <li><a href="/vowl#" download id="exportJson">Export as JSON</a></li>
                    <li><a href="/vowl#" download id="exportSvg">Export as SVG</a></li>
                    <li><a href="/vowl#" download id="exportTex">Export as TeX <label style={{'fontSize': '10px'}}>(alpha)</label></a>
                    </li>
                    <li><a href="/vowl#" download id="exportTurtle">Export as TTL <label style={{'fontSize': '10px'}}>(alpha)</label></a>
                    </li>
                ...
                <ul id="m_about" class="toolTipMenu">
                    ...
                    <li><a href="http://vowl.visualdataweb.org/webvowl.html#releases" target="_blank" rel="noreferrer">Version: <br />(release history)</a></li>

                    <li><a href="http://purl.org/vowl/" target="_blank" rel="noreferrer">VOWL Specification &raquo;</a></li>
                </ul>
            ...
            <div class="noselect" id="swipeBarContainer">
                <ul id="menuElementContainer">
                    <li id="c_search" class="inner-addon left-addon">
                        <i class="searchIcon">
                            <svg viewBox="0 0 24 24" height="100%" width="100%" style={{'pointerEvents': 'none', 'display': 'block'}}>
                                <g>
                                    <path id="magnifyingGlass" style={{'fill' : '#666', 'strokeWidth':0}} d="M15.5 14h-.79l-.28-.27C15.41 12.59 16 11.11 16 9.5 16 5.91 13.09 3 9.5 3S3 5.91 3 9.5 5.91 16 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z">
                                    </path>
                                </g>
                            </svg>
                        </i>
        ...
        <aside id="detailsArea" style={{'backgroundColor': '#18202A'}} class='hidden'>
            ...
            <section id="generalDetails" class="hidden">
                ...
                <span><a id="about" href="/">about</a></span>
                <h5>Version: <span id="version">version</span></h5>
                <h5>Author(s): <span id="authors">authors</span></h5>
                <h5>
                    <label>Language: <select id="language" name="language" size="1">language</select></label>
                </h5>
    ...
    <Helmet>
    <script src='/webvowl/js/d3.min.js' charset="utf-8" type="text/javascript"></script>
    </Helmet>
    <Helmet>
    <script src="/webvowl/js/webvowl.js" charset="utf-8" type="text/javascript"></script>
    </Helmet>
    <Helmet>
    <script src="/webvowl/js/webvowl.app.js" charset="utf-8" type="text/javascript"></script>
    </Helmet>
    <Helmet>
    <script>
