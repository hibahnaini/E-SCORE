...
export const beforeInit = async (crit) =>{
    criterion=crit;
...
const getTree=  async (criteria, row) =>{
  ...
  console.log(root);
  console.log(rel);
  await getAdditionalCriteria(criteria,"ensures").then(()=>
  {
  ...
  await getAdditionalCriteria(criteria,"isAppliedBy").then(()=>{
  ...
  await getAdditionalCriteria(criteria,"precedes").then(()=>{
  ...
  await getAdditionalCriteria(criteria,"provides").then(()=>{
  ...
  await getAdditionalCriteria(criteria,"testsFor").then(()=>{
  ...
  await getAdditionalCriteria(criteria,"conserves").then(()=>{
  ...
  await getAdditionalCriteria(criteria,"revokes").then(()=>{
  ...
  await getAdditionalCriteria(criteria,"contributesTo").then(()=>{
...
export const GenericOverviewFlow = (props) => {
